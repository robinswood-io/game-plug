...
import { OCCUPATIONS, DEFAULT_SKILLS, SKILL_TRANSLATIONS } from '@/lib/cthulhu-data';
...
export default function CharacterEdit() {
  ...
  const updateCharacterMutation = useMutation({
    mutationFn: async (data: CharacterEditForm) => {
      ...
      const response = await apiRequest('PATCH', `/api/characters/${characterId}`, updateData);
    ...
    return (
      <div className="min-h-screen bg-deep-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Button
            onClick={() => router.push(`/gm/${sessionId}`)}
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card className="bg-charcoal border-aged-gold parchment-bg">
              <CardHeader>
                <CardTitle className="font-cinzel text-aged-gold">Statistiques Dérivées</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-charcoal border-aged-gold parchment-bg">
              <CardHeader>
                <CardTitle className="font-cinzel text-aged-gold">Ressources</CardTitle>
              </CardHeader>
              <CardContent>
                <FormField
                  control={form.control}
                      ...
                      return (
                        <div key={skillKey} className="flex justify-between items-center p-2 rounded border border-aged-gold/50 bg-cosmic-void/50">
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-aged-parchment">Base: {baseValue}%</div>
                          </div>
                          <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="text-sm font-bold text-aged-gold w-12 text-right">{currentValue}%</span>
                          </div>
                        </div>
                      );
                    })}
            ...
            <Card className="bg-charcoal border-aged-gold parchment-bg">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    <Label className="text-aged-parchment font-source">Description pour génération IA</Label>
                    <Textarea
