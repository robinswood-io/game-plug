...
import { CharactersService, SessionsService } from '@/lib/api-client';
...
/**
 * Dashboard Home Page - Character List
 * Displays user's characters and active game sessions
 * Now using OpenAPI generated client
 */
export default function DashboardPage() {
  ...
  const { data: sessions = [], isLoading: sessionsLoading } = useQuery({
    queryKey: ['sessions'],
    queryFn: () => SessionsService.sessionsControllerFindAll(''),
  });

  if (charactersLoading || sessionsLoading) {
    return (
